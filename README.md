...
Failure(): Returns a failure result with optional error messages.

Usage:
Result<T>.Succeed() - For successful operations.
Result<T>.Failure() - For failed operations.
...
Failure(): İsteğe bağlı hata mesajları ile başarısız bir sonuç döndürür.

Kullanım:
Result<T>.Succeed() - Başarılı işlemler için.
Result<T>.Failure() - Başarısız işlemler için.
```
